...
public class FactionCommand {
            ...
            .then(Commands.literal("create")
                .then(Commands.argument("id", StringArgumentType.word())
                    .then(Commands.argument("displayName", StringArgumentType.greedyString())
                        .executes(ctx -> createFaction(ctx, 0xFFFFFFFF))
                        .then(Commands.argument("color", IntegerArgumentType.integer(0))
    ...
    private static int createFaction(CommandContext<CommandSourceStack> context) {
        return createFaction(context, IntegerArgumentType.getInteger(context, "color"));
    }

    private static int createFaction(CommandContext<CommandSourceStack> context, int color) {
        ...
        try {
            ...
            source.sendSuccess(() -> Component.literal(
                String.format("§aCreated faction '%s' (%s)", displayName, id)
            ), true);
            return 1;
        } catch (Exception e) {
