...
public class StarlightRenderTypes {
    ...
    public static final RenderType BOSS_BAR_FRAME = RenderType.create("starlight_boss_bar_frame",
    ...
    public static final RenderType BOSS_BAR_FILL = RenderType.create("starlight_boss_bar_fill",
        DefaultVertexFormat.BLOCK,
        VertexFormat.Mode.QUADS,
        256,
        false,
