...
public class AuroraRenderTypes {
    ...
    public static final RenderType BOSS_BAR = RenderType.create("aurora_boss_bar",
    ...
    public static final RenderType ITEM = RenderType.create("aurora_item",
        DefaultVertexFormat.NEW_ENTITY,
        VertexFormat.Mode.QUADS,
        256,
        true,
    ...
    public static final RenderType BLOCK = PresetRenderTypes.block("aurora", SHADER_STATE);
