...
public class ForestRenderTypes {
    ...
    public static final RenderType BOSS_BAR_FRAME = RenderType.create("forest_boss_bar_frame",
    ...
    public static final RenderType BOSS_BAR_FILL = RenderType.create("forest_boss_bar_fill",
        DefaultVertexFormat.BLOCK,
        VertexFormat.Mode.QUADS,
        256,
        false,
