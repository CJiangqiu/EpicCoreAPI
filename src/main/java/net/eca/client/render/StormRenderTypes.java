...
public class StormRenderTypes {
    ...
    private static final RenderStateShard.ShaderStateShard SHADER_STATE = new RenderStateShard.ShaderStateShard(StormShader::getShader) {
        @Override
        public void setupRenderState() {
            super.setupRenderState();
            StormShader.applyUniforms();
        }
    };
