...
public class ArcaneRenderTypes {
    ...
    public static final RenderType BOSS_BAR = RenderType.create("arcane_boss_bar",
    ...
    public static final RenderType ITEM = RenderType.create("arcane_item",
        DefaultVertexFormat.NEW_ENTITY,
        VertexFormat.Mode.QUADS,
        256,
        true,
    ...
    public static final RenderType BLOCK = PresetRenderTypes.block("arcane", SHADER_STATE);
