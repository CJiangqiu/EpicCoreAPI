...
public class VolcanoRenderTypes {
    ...
    private static final RenderStateShard.ShaderStateShard SHADER_STATE = new RenderStateShard.ShaderStateShard(VolcanoShader::getShader) {
        ...
        public void setupRenderState() {
            ...
            VolcanoShader.applyUniforms();
        }
    };

    public static final RenderType BOSS_BAR_FRAME = RenderType.create("volcano_boss_bar_frame",
    ...
    public static final RenderType BOSS_BAR_FILL = RenderType.create("volcano_boss_bar_fill",
        DefaultVertexFormat.BLOCK,
        VertexFormat.Mode.QUADS,
        256,
        false,
    ...
    public static final RenderType BOSS_LAYER = RenderType.create("volcano_boss_layer",
    ...
    public static final RenderType SKYBOX = RenderType.create("volcano_skybox",
        DefaultVertexFormat.BLOCK,
        VertexFormat.Mode.QUADS,
        256,
        true,
