...
public class BlackHoleRenderTypes {
    ...
    private static final RenderStateShard.ShaderStateShard SHADER_STATE = new RenderStateShard.ShaderStateShard(BlackHoleShader::getShader) {
        @Override
        public void setupRenderState() {
            super.setupRenderState();
            BlackHoleShader.applyUniforms();
        }
    };

    public static final RenderType BOSS_BAR_FRAME = RenderType.create("black_hole_boss_bar_frame",
    ...
    public static final RenderType BOSS_BAR_FILL = RenderType.create("black_hole_boss_bar_fill",
        DefaultVertexFormat.BLOCK,
        VertexFormat.Mode.QUADS,
        256,
        false,
